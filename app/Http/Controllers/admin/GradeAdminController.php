...
class GradeAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.grade.grade2-admin', compact('grades'), [
            'title' => 'Grades',
            'grades' => $grades
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/grades/grade-admin')->with('success', 'Grade created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/admin/grades/grade-admin')->with('success', 'Grade updated successfully.');
    }
